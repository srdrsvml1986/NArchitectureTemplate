...
using ValidationException = NArchitectureTemplate.Core.CrossCuttingConcerns.Exception.Types.ValidationException;

namespace NArchitectureTemplate.Core.Application.Pipelines.Validation;
