...
public class ClaimConfiguration : IEntityTypeConfiguration<Claim>
{
    ...
    private IEnumerable<Claim> _seeds
    {
        get
        {
            ...
            IEnumerable<Claim> featureClaims = getSecurityOperationClaims(AdminId);
...
#pragma warning disable S1854 // Unused assignments should be removed
    private IEnumerable<Claim> getSecurityOperationClaims(int initialId)
    {
        int lastId = initialId;
        List<Claim> featureSecurityClaims = new();
