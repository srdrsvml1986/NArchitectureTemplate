...
public class GetByIdUserResponse : IResponse
{
    ...
    public GetByIdUserResponse(Guid id, string firstName, string lastName, string email, bool status, string phoneNumber, DateTime createdAt, DateTime updatedAt, DateTime? birthDate, bool? gender)
    {
        Id = id;
        FirstName = firstName;
        LastName = lastName;
